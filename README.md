...
serverproxy wasn't necessary for noteboook with hidden code to HTML when using the hide code menu on the toolbar. Is it necessary to go to pdf which looks like it uses URL as part of process?
